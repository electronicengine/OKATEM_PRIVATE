...
#include <memory>
#include "../RemoteApptics/connectionwindow.h"
...
QT_MOC_LITERAL(1, 17, 20), // "hideConnectionWindow"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 8), // "accepted"
QT_MOC_LITERAL(4, 48, 8), // "rejected"
QT_MOC_LITERAL(5, 57, 20), // "comboBoxIndexChanged"
QT_MOC_LITERAL(6, 78, 6) // "closed"

    },
    "ConnectionWindow\0hideConnectionWindow\0"
    "\0accepted\0rejected\0comboBoxIndexChanged\0"
    "closed"
};
...
void ConnectionWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hideConnectionWindow(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConnectionWindow::hideConnectionWindow)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ConnectionWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ConnectionWindow.data,
...
// SIGNAL 0
void ConnectionWindow::hideConnectionWindow()
{
